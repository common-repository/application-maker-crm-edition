...
/*TODO:
 * NOTE FOR GUTS DEV:
 * PLEASE ADD in the SQL a check to pick only the Office you want...
 * I'm not sure to understand the note request:
 * -------
 * "This will show completed offices and we will need to insert the link that we are provided so the user
can download the software and we want to include the download link in an email and send it to the
customer.
this is basically a queue of offices that need the link updated"
 * -----------
 */
