...
$app_modules["ff_invoices"] = array(
    ...
    'module_datagrid' => array(
        'filters' => 'assign_to,account_parent_short,contact_parent,project_parent,potential_parent,invoice_status,invoice_date,due_date',
        ...
        'columns_definition' => array(
            ...
            'invoice_date' => array(
                ...
                'width' => '20%',
                "schema" => "<div class=''><span class='row_n '>Sent: {{field}}</span><br/><span class='row_n '>Due: {{due_date}}</span></div>"
            ),
            'due_date' => array(
                'width' => '10%',
            ),
        ...
        'fields_to_load' => 'project_parent,invoice_status,post_title,assign_to,invoice_date,due_date,account_parent_short,contact_parent,potential_parent,post_date',
        'columns_initial_list' => 'post_title,assign_to,invoice_status,account_parent_short,contact_parent,potential_parent,project_parent,invoice_date,post_date',
        'sortby' => 'post_title,assign_to,invoice_date,due_date,account_parent_short,project_parent,contact_parent,potential_parent,post_date',
        'exportfields' => 'project_parent,invoice_status,post_title,assign_to,invoice_date,due_date,account_parent_short,contact_parent,potential_parent,crm_recurring,invoice_status,purchase_order,excise_duty,sales_commission,payment_terms,paid_date,products_list,subtotal,discount,taxes,grand_total,post_date',
        'config' => array(
            'header_a_z' => true,
            'use_paging' => true,
        ),
    ...
    'module_new_categories' => array('cat15_invoices'),
    ...
    'metaboxes' => array(
        ...
        'tasks_infos' => array(
            ...
            'positioning' => array(
                ...
                'main' => array(
                    array(
                        'ref_id', 'crm_recurring', 'set_privacy'
                    ),
                    array(
                        'invoice_status', 'purchase_order'
                    ),
                    array(
                        'invoice_date', 'due_date'
                    ),
                    array(
                        'excise_duty', 'sales_commission'
                    ),
                    array(
                        'payment_terms', 'paid_date'
                    )
                ),
                'tabs' => array(
                    'tabbb' => array(
