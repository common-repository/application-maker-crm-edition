...
$app_modules["ff_project_tasks"] = array(
    'slug' => __('project_tasks'),
    'name' => __('Project Tasks'),
    'menu_name' => __('Proj. Tasks'),
    'singular_name' => __('Project Task'),
    ...
    'migrate_fields_list' => array(
        ...
        'project_task_type,ff_proj_tsk_type',
    ),
    /*  'module_columns_sortby' => array('post_title', 'assign_to', 'start_date', 'due_date', 'account_parent', 'contact_parent', 'project_parent', 'priority', 'status', 'percent_complete', 'task_type', 'post_date'),
      'module_columns' => array('post_title', 'assign_to', 'start_date', 'due_date', 'project_parent', 'account_parent', 'contact_parent', 'priority', 'status', 'percent_complete', 'task_type', 'post_date'),
      'module_columns_filters' => array('account_parent', 'assign_to', 'contact_parent', 'project_parent', 'priority', 'status', 'percent_complete', 'task_type'),
    ...
    'module_datagrid' => array(
        'filters' => 'project_parent,assign_to,priority,status,percent_complete,project_task_type,account_parent,contact_parent',
    ...
    'module_new_categories' => array('cat15_projtasks'),
                ...
                'tabs' => array(
                    'tab_1' => array(
                        ...
                        'items' => array(
                            ...
                            array(
                                'project_task_type', 'percent_complete'//ff_proj_tsk_type
                            ),
                            array(
